...
<ol class="breadcrumb">
  ...
  <li><a href="{{ url('/tryout/soal') }}">Soal</a></li>
...
<div class="col-md-4">
  <div class="box box-success">
    ...
    <div class="box-body">
      <a href="{{ url('/tryout/soal/ubah/'.$id_soal) }}" class="btn btn-primary btn-md">Ubah Data</a>
  ...
  <div class="box box-info">
    ...
    <div class="box-body">
      <p>Seluruh peserta (kelas manapun) dapat mengakses soal yang Anda terbitkan. Soal dalam format latihan bisa dikerjakan berkali-kali oleh peserta yang mengkses soal Anda.</p>
    </div>
  </div>
  @endif
</div>
<div class="col-md-8">
  <div class="box box-primary">
    ...
    <div class="box-body">
      ...
      <a class="pull-right" href="{{ url('/download-file-format/soal') }}"></a>
  ...
  {{-- <div class="box box-warning">
    ...
    <div class="box-body">
      ...
      <form class="form-horizontal" action="{{ url('tryout/soal/essay') }}" method="POST" style="display: none" id="form-essay">
        {{ csrf_field() }}
...
<script>
  $(document).ready(function() {
    ...
    table_soal = $('#table_detail_soal').DataTable({
      ...
      lengthChange: true,
      ajax: {
        url: "{!! route('tryout.get-detail-soal') !!}",
        data: function(d) {
          d.id = id;
        }
      },
    ...
    let table_soal_essay = $("#table_detail_soal_essay").DataTable({
      ...
      lengthChange: true,
      ajax: {
        url: "{{ url('tryout/soal/essay/data') }}",
        data: function(d) {
          d.id_soal = "{{ $soal->id }}"
        }
      },
