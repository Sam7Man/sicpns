        ...
        <form class="form-horizontal" id="formSoal">
          ...
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="paket" placeholder="Paket Soal Tryout">
              </div>
            </div>
            <div class="form-group">
              <label for="paket" class="col-sm-2 control-label">Deskripsi</label>
              <div class="col-sm-8">
                <textarea name="deskripsi" class="form-control" placeholder="Tryout dengan lingkup materi: Tes Intelegensi Umum"></textarea>
              </div>
            </div>
            <div class="form-group">
              <label for="kkm" class="col-sm-2 control-label">Passing Grade</label>
              <div class="col-sm-2">
                <input type="text" class="form-control numOnly" data-toggle="tooltip" title="Passing Grade" name="kkm" placeholder="70">
              </div>
            </div>
            <div class="form-group">
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if (data == 'ok') {
          ...
          window.location.href = "{{ url('/tryout/soal') }}";
        }else{
          $("#loading").hide();
          $("#wrap-btn").show();
