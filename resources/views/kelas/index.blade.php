        ...
        <div class="col-sm-12">
          <div class="col-sm-12">
            <form id="form-kelas" style="display: none; margin: 0 auto 20px;" class="form-horizontal well">
              ...
              <div class="form-group">
                <label for="id_wali" class="col-sm-2 control-label">Pengawas</label>
                <div class="col-sm-10">
                  <select class="form-control" name="id_wali" id="id_wali" placeholder="Pengawas">
    ...
    $(document).ready(function (){
      function checkconnection() {
        ...
        columns: [
          ...
          {data: 'peserta', name: 'peserta', orderable: false, searchable: false },
