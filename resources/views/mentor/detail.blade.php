...
@section('breadcrumb')
  ...
  <ol class="breadcrumb">
    ...
    <li><a href="{{ url('/master/mentor') }}">Mentor</a></li>
...
<div class="col-md-4">
  <div class="box box-primary">
    <div class="box-body box-profile">
      @if($mentor->gambar)
        <img class="profile-user-img img-responsive img-rounded" src="{{ url('/assets/img/user/'.$mentor->gambar) }}" alt="User profile picture">
      @else
      ...
      <hr>
      @if($mentor->status == 'Admin' || $mentor->id == Auth::user()->id)
        <a href="{{ url('/master/mentor/ubah/'.$mentor->id) }}" class="btn btn-primary btn-block"><b><i class="fa fa-edit"></i> Ubah</b></a>
      @endif
    </div>
    <!-- /.box-body -->
  </div>
