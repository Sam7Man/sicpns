@extends('layouts.app')
@section('title', 'SI CPNS - Tryout CPNS')
@section('breadcrumb')
  <h1>Dashboard</h1>
  <ol class="breadcrumb">
    ...
    <form class="form-horizontal" id="formSoal">
      ...
      <div class="box-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-2">
            <input type="text" class="form-control numOnly" data-toggle="tooltip" title="Hanya menerima inputan dalam format numerik" name="kkm" placeholder="Passing Grade" value="{{ $soal->kkm }}">
          </div>
        </div>
        <div class="form-group">
    ...
    $.ajax({
      ...
      success: function(data){
        ...
        if (data == 'ok') {
          ...
          window.location.href = "{{ url('tryout/soal/detail/'.$soal->id) }}";
        }else{
          $("#loading").hide();
          $("#wrap-btn").show();
