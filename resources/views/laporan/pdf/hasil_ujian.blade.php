...
<title>Hasil Ujian {{ $peserta->nama }}</title>
...
<table width="100%">
	...
	<tr>
		<td style="width: 75px">ID Peserta</td>
		<td style="width: 15px">:</td>
...
<hr>
<div class="well">Data soal dibawah ini adalah soal yang telah dikerjakan oleh <b>{{ $peserta->nama }}</b>. Soal yang tidak dikerjakan tidak ditampilkan pada file ini.</div><br>
<table width="100%">
	@if($jawabs->count())
	<?php $no = 1; ?>
