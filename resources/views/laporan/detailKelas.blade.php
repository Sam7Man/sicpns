...
<div class="col-md-4">
  ...
  <div class="box box-danger">
    <div class="box-body">
      <p><i class="fa fa-question-circle" style="color: indianred"></i> Rekap ujian dalam kelas {{ $kelas->nama }}. Daftar paket soal ujian akan tampil jika telah dikerjakan oleh peserta.</p>
    </div>
  </div>
  @endif
</div>
...
$(document).ready(function (){
  table_paket_soal = $('#table_paket_soal').DataTable({
    ...
    lengthChange: true,
    ajax: {
      url: '{!! route('tryout.laporan.data_paket_soal') !!}',
